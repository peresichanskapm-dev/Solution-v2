		...
		<section id="author" className={classes.author}>
			...
			<div className={classes.authorPhotoWrap}>
				<Image
					...
					alt="Олена Третяк"
					fill
					sizes="(max-width: 768px) 172px, 215px"
					className={classes.authorPhoto}
				/>
			</div>

			<blockquote className={classes.authorQuote}>{`“   SOLUTION — це результат усіх років моєї практики, що триває вже понад 10 років. І це стан, який я проживаю і передаю голосом. Голос стає провідником — і тіло, увага, енергія природно переходять в інший режим.     ”`}</blockquote>
		</section>
	);
}
